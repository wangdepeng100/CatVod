...
async function home(filter) {
  ...
  let filterObj = {
    1: [{"key": "type_id", "init":"1", "name": "类型", "value": [{"n": "全部", "v": "1"}, {"n": "喜剧", "v": "6"}, {"n": "爱情", "v": "7"}, {"n": "恐怖", "v": "8"}, {"n": "动作", "v": "9"}, {"n": "科幻", "v": "10"}, {"n": "战争", "v": "11"}, {"n": "犯罪", "v": "12"}, {"n": "动画", "v": "13"}, {"n": "奇幻", "v": "14"}, {"n": "剧情", "v": "15"}, {"n": "剧情", "v": "16"}, {"n": "悬疑", "v": "17"}, {"n": "惊悚", "v": "18"}, {"n": "其他", "v": "19"}]}],
    2: [{"key": "type_id", "init":"2","name": "类型", "value": [{"n": "全部", "v": "2"}, {"n": "大陆", "v": "20"}, {"n": "TVB", "v": "21"}, {"n": "韩剧", "v": "22"}, {"n": "美剧", "v": "23"}, {"n": "日剧", "v": "24"}, {"n": "英剧", "v": "25"}, {"n": "台剧", "v": "26"}, {"n": "其他", "v": "27"}]}],
  };
  return {
    class: classes,
        filters: filterObj,
...
async function category(inReq, _outResp) {
    ...
    let id = ext['type_id'] || tid;
	if(pg <= 0) pg = 1;
    const url = `${siteUrl}/list/${id}-${pg}.html`;
...
*/
  const playlist = $(' ul#play_link li > a')
  .map((_, a) => {
      return a.children[0].data + '$' + a.attribs.href.replace(/.*?\/play\/(.*).html/g, '$1');
  })
  .get();
