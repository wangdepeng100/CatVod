...
let url = '';
let categories = ['国产剧', '香港剧', '韩国剧', '欧美剧', '台湾剧', '日本剧', '海外剧', '泰国剧', '短剧', '动作片', '喜剧片', '爱情片', '科幻片', '恐怖片', '剧情片', '战争片', '动漫片', '大陆综艺', '港台综艺', '日韩综艺', '欧美综艺', '国产动漫', '日韩动漫', '欧美动漫', '港台动漫', '海外动漫', '记录片'];
let headers = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36',
    'Origin': 'www.whbax.cn',
    'Referer': 'www.whbax.cn',
    'Cookie': 'PHPSESSID=7da46a353cf8bac46b4f8226f06042ad'
}
...
async function init(inReq, _outResp) {
    url = inReq.server.config.whbax.url;
    categories = inReq.server.config.whbax.categories;
    return {};
}
